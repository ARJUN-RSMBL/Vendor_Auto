...
export const createDocumentType = (documentType) => {
    return apiClient.post('/api/document-types', documentType);
};

export const updateDocumentType = (typeId, documentType) => {
    return apiClient.put(`/api/document-types/${typeId}`, documentType);
};

export const deleteDocumentType = (typeId) => {
    return apiClient.delete(`/api/document-types/${typeId}`);
};

export const toggleMandatory = (typeId) => {
    return apiClient.put(`/api/document-types/${typeId}/toggle-mandatory`);
};
...
export const getAllDocumentTypes = async () => {
    console.log('Fetching document types...');
    return apiClient.get('/api/document-types');
};
